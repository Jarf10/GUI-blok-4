...
event_e StateMachine::statemachine(event_e eventIn) {
   ...
   switch(currentState) {
      ...
      case S_WAIT_FOR_COINS:
         if(stock <= 0)
         {
            pDialog->setLogger("The coke vending machine is empty\n "
      ...
      case S_100C:
         ...
         break;
      case S_TrashC:
         pDialog->setLogger("-state: Trash Coin");
         nextState = S_Return_Trash;
         eventOut = E_SEQ;
         break;
      ...
      case S_ReturnC:
      {
         ...
         displayBuffer << ": " << money << " cents";
         pDialog->setLogger("-state: Return coin(s), returns"
      ...
      case S_Return_Trash:
         pDialog->setLogger("-state: TRASH, Returning trash coin. ");
         nextState = S_WAIT_FOR_COINS;
         eventOut = E_NO;
         break;
